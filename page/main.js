...
var author$project$Main$canvasHeight = 500;
var author$project$Main$canvasWidth = 500;
...
var author$project$Main$clearCanvas = A2(
	...
	_List_fromArray(
		[
			...
			_Utils_Tuple2(0, 0),
			author$project$Main$canvasWidth,
			author$project$Main$canvasHeight)
		]));
...
var author$project$Main$view = function (model) {
	return A3(
		...
		_Utils_Tuple2(author$project$Main$canvasWidth, author$project$Main$canvasHeight),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						joakin$elm_canvas$Canvas$Settings$fill(
						A3(avh4$elm_color$Color$rgb, 0.4, 0, 0.7))
					]),
				_List_fromArray(
					[
						A2(
