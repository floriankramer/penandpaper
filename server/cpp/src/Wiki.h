...
class Wiki : public HttpServer::RequestHandler {
  ...
  class Entry {
   public:
    ...
    const std::vector<std::string> *getAttribute(
     ...
     */
    void loadAttribute(const std::string &predicate, const std::string &value);

    void addAttribute(const std::string &predicate, const std::string &value);
   ...
   private:
    void writeAttribute(const std::string &predicate, const std::string &value);
    ...
    std::unordered_map<std::string, std::vector<std::string>> _attributes;
